...
- 실시간 경과 일수·시간 표시
- 1/3/7일 이후 매주 진화하는 55개 성장 단계
- 화분·새싹·잎·꽃·뿌리·묘목·나무·열매로 이어지는 성장 서사
- 코드로 그린 벡터 식물과 흔들림·개화·낙엽·시듦 애니메이션
- 실패 원인과 메모 기록, 자동 재시작
- 365일 캘린더
- 가장 흔한 실패 원인과 개선 제안
- 60초 호흡, 동기 문구, 음악·영상·명상 링크
- 철학·사상·성경의 출처별 핵심과 정확히 연결된 370개의 오늘의 성찰
- 오늘의 성찰과 연결된 웹 읽을거리·YouTube 검색
- 기록 전체를 JSON으로 백업한 뒤 새로 시작하는 안전 초기화
- 화면 좌하단 투명 식물 위젯
...
설정의 "백업하고 초기화"를 누르면 현재 시도, 실패 원인, 메모, 충동 기록을 먼저
문서\Seed Backups 폴더의 JSON 파일로 저장합니다. 백업 생성에 성공한 경우에만
현재 기록을 비우고 새 씨앗으로 시작합니다.
